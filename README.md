...
Live at **[seniorki.no](https://seniorki.no)**. 

![SeniorKI welcome screen on a tablet](docs/welcome.jpeg)
...
🌐 [Link to thesis](docs/thesis.pdf)    
...
![Course overview with two completed chapters](docs/course-overview.jpg)
...
![Chapter overview for "Generativ KI"](docs/chapter-overview.jpg)
...
![Topic content page](docs/topic.jpg)
...
![Quiz feedback: wrong answer in red, correct answer in green](docs/quiz-feedback.jpg)
...
![Quiz results with stars, new badges and answer review](docs/quiz-results.jpg)
...
![Badge earned screen](docs/badge-earned.jpg)

Badges are awarded on a dedicated screen, one at a time.

### Progress

![Progress page with per-chapter progress bars](docs/progress.jpg)
![Badge collection](docs/badges.jpg)
...
<tr>
<td><img src="docs/iter1-course-overview.jpg" alt="Round 1 course overview: single column of chapter cards with progress bars, a stepper at the top, and a 'scroll down for the rest' instruction"></td>
<td><img src="docs/course-overview.jpg" alt="Final course overview: two-column grid of six chapter cards with a one-line progress summary"></td>
</tr>
<tr>
...
<tr>
<td><img src="docs/iter1-chapter-overview.jpg" alt="Round 1 chapter overview: three topic cards stacked above two activity cards, with 'scroll down to see activities'"></td>
<td><img src="docs/chapter-overview.jpg" alt="Final chapter overview: numbered topics on the left, quiz on the right, with explicit headings"></td>
</tr>
<tr>
...
<tr>
<td><img src="docs/iter1-progress.jpg" alt="Round 1 rewards page: summary boxes for stars, chapters and badges, and illustrated robot badges"></td>
<td><img src="docs/progress.jpg" alt="Final progress page with per-chapter progress bars"></td>
</tr>
<tr>
...
- **Known gaps:** there has been no screen reader or expert accessibility testing, and no testing with users with disabilities.
